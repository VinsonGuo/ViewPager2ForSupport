 ...
 */
public class ViewPager2LinearLayoutManager extends RecyclerView.LayoutManager implements
    ...
    int mOrientation = ViewPager2.ORIENTATION_HORIZONTAL;
     ...
     */
    public ViewPager2LinearLayoutManager(Context context) {
     ...
     */
    public ViewPager2LinearLayoutManager(Context context, @RecyclerView.Orientation int orientation,
     ...
     */
    public ViewPager2LinearLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
                               int defStyleRes) {
